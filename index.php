...
Please enter here your URL to your Run in "Zombies, Run". <br \>
With this a gpx-file will be generated, which you can upload in your Trackingtool.<br \>
Takk fyrir.<br \>


   <form action="index.php" method="GET"> 
   <!-- <form action="zombie.php" method="GET"> -->
 <p>url: <input type="text" name="url" /></p>
 <p><input type="submit" value="generate GPX-file"></p>
</form>  
<?
